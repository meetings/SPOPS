...
# $Id: 00_base.t,v 1.2 2002/08/21 18:48:05 lachoy Exp $
...

{
    ...
    # Strict field checking
    {
        ...
        my $collector = undef;
        local $SIG{__WARN__} = sub { $collector = join( '', @_ ); return };
        $item_strict->{foo} = 'bar';
        ok( $collector, 'Strict field assignment caused warning (good)' );
    }
