...
An arrayref of fieldnames used in this object.
...
object. Currently, multi-field primary keys are not supported.
...
only deleting the link rather than deleting an object. See
L<SPOPS::ClassFactory::DBI|SPOPS::ClassFactory::DBI> for another
proposal.
