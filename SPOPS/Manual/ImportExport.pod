...
Currently SPOPS data import options are an object import, called using
the 'object' key, and a raw data import for DBI tables, called using
the 'dbdata' key. See L<SPOPS::Import::Object|SPOPS::Import::Object>
and L<SPOPS::Import::DBI::Data|SPOPS::Import::DBI::Data> for more
information specific to each import format.
